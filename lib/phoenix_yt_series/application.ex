defmodule PhoenixYtSeries.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Finch, name: PhoenixYtSeries.Finch},
    ...
    opts = [strategy: :one_for_one, name: PhoenixYtSeries.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixYtSeriesWeb.Endpoint.config_change(changed, removed)
    :ok
  end
